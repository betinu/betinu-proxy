...
MyLibrary.tokenAddress = '0xBFD48bB6639FEad410905db2272fcb57708578F7';
MyLibrary.liquidity_pool_addy = '0x5732F2938D6a95f1e98B3Cf67e4Afb56D2584121'; 
...
async function balanceOf(account){
	tokenInst.methods.balanceOf(account).call().then(function (result,error) {
		...
		if (!error && result) {
			 ...
			 $('#wallet_balance').empty().append(balance+' BENU');					 
